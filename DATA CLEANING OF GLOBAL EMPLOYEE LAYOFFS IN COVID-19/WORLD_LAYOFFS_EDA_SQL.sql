...
SELECT * FROM layoffs
WHERE funds_raised_millions IS NOT NULL AND NOT funds_raised_millions=0
ORDER BY funds_raised_millions ASC
LIMIT 1;

SELECT *
FROM layoffs
WHERE funds_raised_millions = (SELECT MAX(funds_raised_millions) 
FROM layoffs
WHERE funds_raised_millions IS NOT NULL AND NOT funds_raised_millions=0);

SELECT RTRIM("        YOGESH      ")AS NAME, TRIM("          YOGESH      ");
